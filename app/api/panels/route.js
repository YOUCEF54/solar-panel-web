...
const mockPanels = [
  {
    ...
    thumbnail: 'https://via.placeholder.com/400x300?text=Panel+P-1',
  ...
  },
  {
    ...
    thumbnail: 'https://via.placeholder.com/400x300?text=Panel+P-2',
    last_update: new Date().toISOString(),
    id: 'P-2',
    status: 'dusty',
  ...
  },
  {
    ...
    thumbnail: 'https://via.placeholder.com/400x300?text=Panel+P-3',
    last_update: new Date().toISOString(),
    id: 'P-3',
    status: 'damaged',
...
function normalizePanel(panel) {
  ...
  const thumbnail = panel.thumbnail ?? panel.imageUrl ?? panel.image_url
