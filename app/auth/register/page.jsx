        ...
        return (
            <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
                <div className="max-w-md w-full p-8 bg-white shadow-xl rounded-2xl text-center">
                    ...
                    <p className="text-gray-600">Your account has been created. Simulating redirection to the dashboard...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4 font-sans">
            <div className="max-w-md w-full p-8 bg-white shadow-2xl rounded-xl border border-gray-200">
                ...
                <form className="space-y-4" onSubmit={handleSignUp}>
                    ...
                    {passwordStrength.score < 3 && password.length > 0 && (
                        <p className="text-center text-xs text-red-500">
                            * Password must be rated Good or Strong to create an account.
                        </p>
                    )}
                </form>
